          ...
          >
            ...
            >
              ...
              >
                ...
                <br />
                Unlock a world of sophistication and prestige as you invest in
                the most coveted real estate opportunities in Dubai
              </h2>

              <Link href="tel:+971521642020">
                <button
                  type="button"
                  style={{
                    position: 'relative',
                  ...
                  onMouseOver={(e) => (e.target.style.color = '#ECA33A')}
                  onMouseOut={(e) => (e.target.style.color = 'white')} // Set back to original color on mouse out
                >
                  CALL US
                </button>
              </Link>
              ...
              <div className="flex pr-[20px] max-[1024px]:pr-[2%]">
                <div className="w-2/4 h-3/4 mr-4 max-[1024px]:mr-[2%] innerBox buyBox">
                  ...
                  <button class="customGoldButton w-full font-semibold text-[20px] px-10 py-2 w-[200px] mr-2 border-b-4 border-[#EEC78C]">
                    <Link className="text-white" href="/products/buy">
                      <span> BUY </span>
                    </Link>
                  </button>
                  <div
