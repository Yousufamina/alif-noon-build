      ...
      <main className={`${bgColor} productSection pt-[60px]`}>
        ...
        <div className="mainContainer">
          <div className="productSectionHeader text-center">
            <h5 className="uppercase text-[25px] text-white">
              {subHeadingTop}
            </h5>
            <h1 className="leading-[70px] uppercase raleway font-semibold text-[55px] text-[#ECA33A]">
              {heading}
            </h1>
            <h4 className="max-[780px]:text-[18px] raleway-light font-regular text-[24px] text-white">
              {subHeadingBottom}
            </h4>
          </div>
          {
