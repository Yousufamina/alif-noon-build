...
const FreeConsultation = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.sendForm('service_y7n5bh3', 'template_2dy764k', form.current , 'DvNf_xZQEKCCfTPrU')
      .then((result) => {
        ...
        <div className="mainContainer text-center">
          <div className='SubFreeConseltation'>
            <div style={{ borderRadius: '10px' }}>
              <form ref={form} onSubmit={handleSubmit} className='FreeConseltationInput'>
                ...
                <button type="submit" value="Send" className='FreeConseltationColumn rounded-r-[4px] text-[#ECA33A] bg-[#231F20] hover:text-white hover:bg-[#ECA33A] leading-[35px] text-[20px] raleway transition ease-in-out delay-150 hover:border-[#ECA33A]'>
                  Consult Now
                </button>
              </form>
            </div>
          ...
          <div className='flex justify-center mt-[8px]'>
            <div className='flex max-[780px]:flex-col justify-center items-center'>
              ...
              <a href="https://wa.me/+923040602781">
