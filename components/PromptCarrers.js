...
function PromptCarrers({ closeCarrersModal }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex justify-end cursor-pointer" onClick={closeCarrersModal}>
          ...
          <div className="mainContainer">
            <div className="formBox">
              ...
              <h2 className="text-lg md:text-2xl text-center">
                We will contact you if we find suitable position 
              </h2>
              <form 
              ref={form}
